...
import pickle
class cifar100net:
    def __init__(self,num_classes=100,minibatchsize=1,imagesize=32,dropout_keep_prob=1 ,scope='cifarnet' ,learningrate = 0.001,momentum = 0.5,tradeoff = 0):
...
#            begin += 10
            ...
            # y_one_hot = tf.one_hot(self.label,100)
