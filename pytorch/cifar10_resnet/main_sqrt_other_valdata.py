...
trainloader = torch.utils.data.DataLoader(trainset[:48000], batch_size=128, shuffle=True, num_workers=5)

trainset_1 = torchvision.datasets.CIFAR10(root='./data', train=True, download=True, transform=transform_train)
trainloader_1 = torch.utils.data.DataLoader(trainset_1[48000:], batch_size=2000, shuffle=True, num_workers=5)
...
print(info)
file_index = '_entropy_sqrt_other_valdata'
